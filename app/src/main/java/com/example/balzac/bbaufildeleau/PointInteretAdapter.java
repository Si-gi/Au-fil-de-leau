...
import com.example.balzac.bbaufildeleau.PointInteret;
import com.example.balzac.bbaufildeleau.R;

import java.util.List;

public class PointInteretAdapter extends ArrayAdapter<PointInteret> {
    private Activity activity;
    private List<PointInteret> items;
    private PointInteret objBean;
    private int row;
    public PointInteretAdapter(Activity act, int resource, List<PointInteret> arrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.elem_patri = (TextView) view.findViewById(R.id.elem_patri);
        holder.comunne = (TextView) view.findViewById(R.id.comunne);
        holder.ensem2 = (TextView) view.findViewById(R.id.ensem2);
        holder.date_construc = (TextView) view.findViewById(R.id.date_construc);
        holder.commentaire = (TextView) view.findViewById(R.id.commentaire);
        holder.elem_princip = (TextView) view.findViewById(R.id.elem_princip);
        holder.favorite = (TextView) view.findViewById(R.id.favorite);
        holder.pontid = (TextView) view.findViewById(R.id.pont_id);
